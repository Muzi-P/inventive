        ...
        <div class="col-lg-4">
          <div class="item">
            ...
            <div class="cont">
              ...
              <p v-for="number, idx in info.numbers" :key="idx">{{ number }}</p>
            </div>
          </div>
        </div>
        <div class="col-lg-4">
          <div class="item">
            ...
            <div class="cont">
              ...
              <p v-for="email, idx in info.emails" :key="idx">{{ email }}</p>
            </div>
          </div>
        </div>
        <div class="col-lg-4">
          <div class="item">
            ...
            <div class="cont">
              ...
              <p v-for="address, idx in info.addresses" :key="idx">{{ address }}</p>
            </div>
          </div>
        </div>
      </div>
