export default {
  ...
  head: {
    ...
    meta: [
      ...
      { hid: 'description', name: 'description', content: 'Mon Reve - Where Your Event Dreams Come True' },
      { hid: 'keywords', name: 'keywords', content: 'Mon Reve - Where Your Event Dreams Come True' },
  ...
  plugins: [
    ...
    { src: "~plugins/elementUi", ssr: false, mode: "client" }
  ],
  ...
  // if Nuxt is in SPA mode to fallback to 200.html when a page can't be found.
  generate: {
    fallback: true
  }
}
